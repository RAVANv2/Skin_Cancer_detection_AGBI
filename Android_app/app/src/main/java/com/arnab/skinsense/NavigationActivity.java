...
public class NavigationActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                android.util.Log.d("Sid", "Detection Activity");
        ...
        ImageView StartButton = (ImageView) findViewById(R.id.btnChatbot);
        StartButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(NavigationActivity.this, Chatbot.class));
            }
        });

        Button visit=(Button) findViewById(R.id.visit_us);
        visit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://192.168.1.26:7007")));
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            Intent i = new Intent(NavigationActivity.this,Map_webview.class);
            startActivity(i);
